// all credits to https://github.com/Fa-So/react-bootstrap-tagsinput
...
export const InputTags = ({
  ...
  const onkeyup = (event: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    const isPossibleRight = (isEndOfText || currentValue.length === 0) && terms.length > 0;
...
const Element = (props: ElementProps): JSX.Element => {
  ...
  return (
    ...
    <div
      ...
      ref={ref}
      tabIndex={-1}
      className={classnames('badge badge-secondary mr-1 my-auto py-auto pr-0 ', props.className)}
      onKeyUp={onkeydown}
      onFocus={() => {
        setFocus(true);
      }}
      ...
      <button
        ...
        // onClick={onclick}
      >
        <Cancel style={{ fill: 'var(--bs-white)', opacity: 1 }} width={18} height={18} />
      </button>
    </div>
  );
};
