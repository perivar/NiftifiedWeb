...
import { loadStripe, PaymentMethod, StripeCardElementOptions } from '@stripe/stripe-js';
import { CardElement, Elements, useElements, useStripe } from '@stripe/react-stripe-js';
import { chargeService, alertService } from '../../_services';
...
export const StripeCheckoutFormOld = ({ productList }: { productList: ProductList | undefined }) => {
  ...
  const submitPayment = (paymentMethod: PaymentMethod) => {
    try {
      const order = {
        ...
        productName: 'Niftified Product',
        amount: productList?.totalToPay.toString().replace('.', ''),
        currency: 'nok',
      ...
      chargeService
        .createCharge(order)
        .then(() => {
          alertService.success('Successful payment', {
                      ...
                      <>
                          ...
                          <>
                            <div className="row">
                              ...
                              <div className="col-8">
                                <div className="row">
                                  <b>
                                    {productList.currency} {p.unitPrice}
                                  </b>
                                </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col text-right">
                            {productList.currency} {productList.subTotal}
                          </div>
                        </div>
                        <div className="row">
                          <div className="col text-left">Delivery</div>
                          <div className="col text-right">
                            {productList.deliveryCost !== 0 ? productList.deliveryCost : 'Free'}
                          </div>
                        </div>
                        <div className="row">
                          ...
                          <div className="col text-right">
                            <b>
                              {productList.currency} {productList.totalToPay}
                            </b>
                          </div>
                        </div>
                      </>
                  ...
                  <div className="card">
                    ...
                    <div className="card-footer">
                      <SubmitButton processing={processing} error={error} disabled={!stripe}>
                        Pay {productList ? `${productList.currency} ${productList.totalToPay}` : 0}
                      </SubmitButton>
                    </div>
                  </div>
                </form>
